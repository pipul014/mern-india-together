...
import IndiaCountryVisitPlaces from "../components/IndiaCountry/IndiaCountryVisitPlaces";
import IndiaCountryTogether from "../components/IndiaCountry/IndiaCountryTogether";

import Footer from "../components/Footer";
import HeroBanner from "../components/HeroBanner";

const ThingsToDoIndia = () => {
  return (
    <>
      <div className="mt-32">
...
export default ThingsToDoIndia;
