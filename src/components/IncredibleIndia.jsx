...
const regions = [
  { name: "Uttar Pradesh", path: "/india-state?name=Uttar+Pradesh" },
  { name: "Tamil Nadu", path: "/india-state?name=Tamil+Nadu" },
  { name: "Rajasthan", path: "/india-state?name=Rajasthan" },
  { name: "Madhya Pradesh", path: "/india-state?name=Madhya+Pradesh" },
  { name: "Karnataka", path: "/india-state?name=Karnataka" },
];
