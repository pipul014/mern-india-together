...
import NotificationCard from "../../components/ThingsToDoDomestic/NotificationCard";

const SidebarAttraction = () => {
  // Sidebar section data
  const sections = [
    {
      title: "Type of Attractions",
      color: "text-[#DC3545]",
      options: [
        { label: "All Attractions", checked: true },
        { label: "Top Attractions" },
        { label: "Sightseeings & Landmarks" },
        { label: "Museums & Art Galleries" },
        { label: "Nature & Parks" },
        { label: "Zoos & Aquariumsr" },
        { label: "Religious Places" },
        { label: "Kids Attractions" },
        { label: "Tribal Attractions" },
        { label: "Hidden Attractions" },
        { label: "Theme Parks" },
      ],
    },
    {
      ...
      color: "text-[#DC3545]",
      options: [
        { label: "Attractions within City Limits" },
        { label: "Attractions outside City Limits" },
      ],
    },
    {
      title: "Good For",
  ...
  return (
    <div className="w-[325px]">
      ...
      <div className="w-full">
        <button className="border w-full h-14  mb-8 mt-12 border-[#838383] text-gray-900">
          <p className="text-xl font-semibold">Book a Guide</p>
          <p className="text-md">People who knows their city the best.</p>
        </button>
      </div>
...
export default SidebarAttraction;
