      ...
      <div className="py-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {places.map((place) => (
            <div
              key={place.id}
              className="bg-white shadow-md overflow-hidden hover:shadow-lg transition relative"
            >
              {/* Image Section */}
              <div className="relative">
                <img
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg">
                  <Link
                    to={`/attraction?name=${encodeURIComponent(place.title2)}`}
                ...
                {/* ✅ Read More also navigates to attraction */}
                <Link
                  to={`/attraction?name=${encodeURIComponent(place.title2)}`}
