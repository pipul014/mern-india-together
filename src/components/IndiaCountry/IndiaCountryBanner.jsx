...
const IndiaCountryBanner = ({ heading }) => {
  ...
  useEffect(() => {
    if (currentPath !== "/india-country") return;
  ...
  return (
    <>
      {/* <section className=" h-[480px] md:h-[500px] lg:h-[600px] w-full overflow-hidden"> */}
...
export default IndiaCountryBanner;
