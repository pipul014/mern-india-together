...
const IndiaStateTab = () => {
  ...
  const tabs = ["TamilNadu", "Hotels", "Things to Do", "Eat & Drink", "Shop"];

  const routes = {
    TamilNadu: "/india-State",
    Hotels: "/india-state-hotels",
    "Things to Do": "/india-state-things-to-do",
    "Eat & Drink": "/india-state-eat-drink",
    Shop: "/india-state-shop",
  };
