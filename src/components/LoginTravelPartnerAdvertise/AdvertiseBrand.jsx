...
const AdvertiseBrand = () => {
  const brands = [
    ...
    { id: 10, name: "Brand 10", logo: Brand10 },
    { id: 11, name: "Brand 11", logo: Brand11 },
    { id: 12, name: "Brand 12", logo: Brand2 },
    { id: 13, name: "Brand 13", logo: Brand3 },
    { id: 14, name: "Brand 14", logo: Brand4 },
  ];
  return (
    <>
      <div className="mt-24">
        <p className="text-2xl font-semibold">
          Be part of the growing network of trusted brands on Together in India.
        </p>
      </div>

      {/* Breands */}
      <div className="pt-10 pb-36  w-[80%]">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 gap-6 items-center  justify-center">
            {brands.map((brand) => (
              <div
                key={brand.id}
